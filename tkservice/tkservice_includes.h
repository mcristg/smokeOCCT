...
class Make_Graphic3d_Vec2 {
public:
  Make_Graphic3d_Vec2() : vec(){}
  Make_Graphic3d_Vec2(const Standard_ShortReal val) : vec(val){}
  Make_Graphic3d_Vec2(const Standard_ShortReal theX, const Standard_ShortReal theY) : vec(theX, theY){}
  Graphic3d_Vec2 &get() {return vec;}
  void SetValues(const Standard_ShortReal theX, const Standard_ShortReal theY) {vec.SetValues(theX, theY);}
  Standard_ShortReal x() {return vec.x();}
  Standard_ShortReal y() {return vec.y();}
  bool IsEqual (const Graphic3d_Vec2 &theOther) {return vec.IsEqual(theOther);}
  const Standard_ShortReal *GetData () {return vec.GetData();} 
private:
  Graphic3d_Vec2 vec;
};

class Make_Graphic3d_Vec2d {
public:
  Make_Graphic3d_Vec2d() : vec(){}
  Make_Graphic3d_Vec2d(const Standard_Real val) : vec(val){}
  Make_Graphic3d_Vec2d(const Standard_Real theX, const Standard_Real theY) : vec(theX, theY){}
  Graphic3d_Vec2d &get() {return vec;}
  void SetValues(const Standard_Real theX, const Standard_Real theY) {vec.SetValues(theX, theY);}
  Standard_Real x() {return vec.x();}
  Standard_Real y() {return vec.y();}
  bool IsEqual (const Graphic3d_Vec2d &theOther) {return vec.IsEqual(theOther);}
  const Standard_Real *GetData () {return vec.GetData();} 
private:
  Graphic3d_Vec2d vec;
};

class Make_Graphic3d_Vec2i {
public:
  Make_Graphic3d_Vec2i() : vec(){}
  Make_Graphic3d_Vec2i(const Standard_Integer val) : vec(val){}
  Make_Graphic3d_Vec2i(const Standard_Integer theX, const Standard_Integer theY) : vec(theX, theY){}
  Make_Graphic3d_Vec2i(const Graphic3d_Vec2d &vec) : vec(vec){}
  Graphic3d_Vec2i &get() {return vec;}
  void SetValues(const Standard_Integer theX, const Standard_Integer theY) {vec.SetValues(theX, theY);}
  Standard_Integer x() {return vec.x();}
  Standard_Integer y() {return vec.y();}
  bool IsEqual (const Graphic3d_Vec2i &theOther) {return vec.IsEqual(theOther);}
  const Standard_Integer *GetData () {return vec.GetData();} 
private:
  Graphic3d_Vec2i vec;
};

class Make_Graphic3d_Vec2u {
public:
  Make_Graphic3d_Vec2u() : vec(){}
  Make_Graphic3d_Vec2u(const unsigned int val) : vec(val){}
  Make_Graphic3d_Vec2u(const unsigned int theX, const unsigned int theY) : vec(theX, theY){}
  Graphic3d_Vec2u &get() {return vec;}
  void SetValues(const unsigned int theX, const unsigned int theY) {vec.SetValues(theX, theY);}
  unsigned int x() {return vec.x();}
  unsigned int y() {return vec.y();}
  bool IsEqual (const Graphic3d_Vec2u &theOther) {return vec.IsEqual(theOther);}
  const unsigned int *GetData () {return vec.GetData();} 
private:
  Graphic3d_Vec2u vec;
};

class Make_Graphic3d_Vec2ub {
public:
  Make_Graphic3d_Vec2ub() : vec(){}
  Make_Graphic3d_Vec2ub(const Standard_Byte val) : vec(val){}
  Make_Graphic3d_Vec2ub(const Standard_Byte theX, const Standard_Byte theY) : vec(theX, theY){}
  Graphic3d_Vec2ub &get() {return vec;}
  void SetValues(const Standard_Byte theX, const Standard_Byte theY) {vec.SetValues(theX, theY);}
  Standard_Byte x() {return vec.x();}
  Standard_Byte y() {return vec.y();}
  bool IsEqual (const Graphic3d_Vec2ub &theOther) {return vec.IsEqual(theOther);}
  const Standard_Byte *GetData () {return vec.GetData();} 
private:
  Graphic3d_Vec2ub vec;
};

class Make_Graphic3d_Vec2b {
public:
  Make_Graphic3d_Vec2b() : vec(){}
  Make_Graphic3d_Vec2b(const Standard_Character val) : vec(val){}
  Make_Graphic3d_Vec2b(const Standard_Character theX, const Standard_Character theY) : vec(theX, theY){}
  Graphic3d_Vec2b &get() {return vec;}
  void SetValues(const Standard_Character theX, const Standard_Character theY) {vec.SetValues(theX, theY);}
  Standard_Character x() {return vec.x();}
  Standard_Character y() {return vec.y();}
  bool IsEqual (const Graphic3d_Vec2b &theOther) {return vec.IsEqual(theOther);}
  const Standard_Character *GetData () {return vec.GetData();} 
private:
  Graphic3d_Vec2b vec;
};
